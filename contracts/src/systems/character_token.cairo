...
mod character_token {
    ...
    mod Errors {
        const CALLER_IS_NOT_MINTER: felt252 = 'CharToken: caller is not minter';
    }

    fn dojo_init(ref self: ContractState) {
        let TOKEN_NAME = "zIdle Character";
        let TOKEN_SYMBOL = "ZIC";
        let BASE_URI = "";
    ...
    //
    #[abi(embed_v0)]
    impl CharacterTokenPublicImpl of super::ICharacterTokenPublic<ContractState> {
