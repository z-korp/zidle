...
#[starknet::contract]
mod CharacterErc721 {
    use super::account_deployer;
    use super::interfaces::account::{iaccount, IAccountDispatcherTrait};
    use super::components::erc721_wallet::{Erc721WalletComponent};
